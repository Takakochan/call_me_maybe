...
exercises: dict[Callable, dict[str, Any]] = {
    ...
    fn_add_numbers: {
        "visibility": "public",
        "tests": [
            {"prompt": "What is the sum of 2 and 3?", "fn_args": {"a": 2.0, "b": 3.0}},
            {
    ...
    fn_get_square_root: {
        "visibility": "public",
        "tests": [
            {"prompt": "What is the square root of 16?", "fn_args": {"a": 16.0}},
            {"prompt": "Calculate the square root of 144", "fn_args": {"a": 144.0}},
        ],
    },
        ...
        "tests": [
            {
                ...
                "fn_args": {"query": "SELECT * FROM users", "database": "production"},
            },
            {
...
def get_exercises_by_visibility(visibility: str) -> dict[Callable, dict[str, Any]]:
    ...
    return {
        fn: data for fn, data in exercises.items() if data["visibility"] == visibility
    }
